...
Hypothesis testing with data visualization 
...
From the plot, we can see life expectancy increasing as total fertility rate decreases. Thus, we can reject the null hypothesis and conclude that decreased Total Fertility Rates are associated with increased life expectrancies. 
...
animated_plot <- plot + 
  ...
  ease_aes('linear')  # This line makes the transitions smoother

# Slow down the animation using `animate()`
animated_plot <- animate(animated_plot, 
                         duration = 10,  # Duration of the animation in seconds
                         fps = 5,        # Frames per second (lower FPS slows the animation)
                         end_pause = 10, # Pause at the end to hold the last frame
                         rewind = FALSE) # Option to not rewind the animation after completion
